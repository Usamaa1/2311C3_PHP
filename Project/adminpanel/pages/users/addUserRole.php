                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Add UserRole</h4>
                                    ...
                                    <form class="forms-sample" method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputName1" name="userRole" placeholder="User Role">
                                        </div>
                           
                                       

                                        <button type="submit" class="btn btn-primary mr-2" name="addUserRoleBtn">Add UserRole</button>
                                    </form>
                                </div>
                            </div>
                        </div>
