      ...
      <?php
        ...
        if(isset($_POST['btn']))
        {
          ...
          else
          {
            ...
            $insertQuery= "INSERT INTO `country`(`country_name`) VALUES (:countryName)";
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" name="countryName" placeholder="Country Name">
                    </div>
                
                    <button type="submit" class="btn btn-primary mr-2" name="btn">Add Country</button>
                  </form>
                </div>
              </div>
            </div>
